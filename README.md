...
2. Put this in your header: `<script type="text/javascript" src="/path/to/memoize.js"></script>`

3. Instead of using `document.querySelector(query)`, use `memoize.query(query)`. Instead of using `document.getElementById(id)`, use `memoize.id(id)`.
